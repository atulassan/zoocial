...
this.$gall.addClass(this.options.theme);1==this.currentImage?this.$gall.find(".eagle-prev").addClass("disabled"):this.currentImage==b.find(".owl-item").length&&this.$gall.find(".eagle-next").addClass("disabled");1==this.numberOfimages&&this.$gall.find(".eagle-next").addClass("disabled");this.global.open=this.$gall;this.showGallery()},showGallery:function(){var a=this,b=d("body").width(),c=d("body").outerWidth();b!=c&&(d("body").css({"padding-right":0}),a.bodyRightPadding=c-d("body").width(),a.bodyRightPadding=
c-b-a.bodyRightPadding);d("body").css({overflow:"hidden"});b=d("body").outerWidth()-c;void 0!=a.bodyRightPadding?d("body").css({"padding-right":b+a.bodyRightPadding}):d("body").css({"padding-right":b});a.$gall.css(n.addCssSpeed(a.options.openGallerySpeed));"show"==a.options.openGalleryStyle&&setTimeout(function(){a.$gall.css({opacity:1})},10);"transform"==a.options.openGalleryStyle&&(setTimeout(function(){a.$gall.css({opacity:1,"-webkit-transform":"scale3d(1, 1, 1)","-o-transform":"scale3d(1, 1, 1)",
"-ms-transform":"scale3d(1, 1, 1)","-moz-transform":"scale3d(1, 1, 1)",transform:"scale3d(1, 1, 1)"})},10),setTimeout(function(){a.$gall.find(".top-controls, .bottom-controls").removeClass("ea-hide")},a.options.openGallerySpeed+400),setTimeout(function(){function b(){c+=1;n.completeImg(a.$gall.find(".owl-item.active img").get(0))?a.$gall.find(".view-big-img").removeClass("ea-hide"):100>=c?k.setTimeout(b,100):a.$gall.find(".view-big-img").removeClass("ea-hide")}var c=0;b()},a.options.openGallerySpeed+
800),setTimeout(function(){a.$elem.find(".transform").length&&a.$gall.find(".eagle-prev, .eagle-next").removeClass("ea-hide")},a.options.openGallerySpeed+1300),setTimeout(function(){a.$elem.find(".transform").length&&a.$gall.removeClass("transform")},a.options.openGallerySpeed+2300));a.$gall.bind("touchmove",function(a){a.preventDefault()});a.$gall.find(".owl-carousel").owlCarouselE(a.galleryOptions);a.owlGallery=a.$gall.find(".owl-carousel").data("owlCarouselE");a.owlGallery.jumpTo(a.currentImage-
1);a.whenGalleryOpened()},whenGalleryOpened:function(){this.$gall.find(".top-controls, .bottom-controls").css(n.addCssSpeed(this.options.hideControlsSpeed));this.galleryEvents();this.mouseDown();this.gestures();this.response()},galleryEvents:function(){var a=this;a.$gall.on("click",".eagle-prev",function(){a.owlGallery.prev()});a.$gall.on("click",".eagle-next",function(){a.owlGallery.next()});a.$gall.on("click",".view-big-img",function(){a.hideControls()});a.$gall.on("click",".eagle-close",function(){a.close()})},
mouseDown:function(){this.$gall.find(".eagle-item").on("mousedown",function(){d(this).addClass("mouse-down")}).on("mouseup",function(){d(this).removeClass("mouse-down")})},gestures:function(){function a(a){var b=e.$gall.find(".owl-item.active").offset();if(void 0!==a.touches)return d.map(a.touches,function(a){return{x:a.pageX-b.left,y:a.pageY-b.top}});if(void 0===a.touches){if(void 0!==a.pageX)return d.map(a,function(a){return{x:a.pageX,y:a.pageY}});if(void 0===a.pageX)return d.map(a,function(a){return{x:a.clientX,
y:a.clientY}})}}function b(a,b){var e,c;e=a.x-b.x;c=a.y-b.y;return Math.sqrt(e*e+c*c)}function c(a,e){var c=b(a[0],a[1]);return b(e[0],e[1])/c}function h(a){"on"===a?(e.$gall.on(e.ev_types.moveZoom,".owl-item",f),e.$gall.on(e.ev_types.endZoom,".owl-item",g)):"off"===a&&(e.$gall.off(e.ev_types.moveZoom,".owl-item",f),e.$gall.off(e.ev_types.endZoom,".owl-item",g))}function f(b){b=b.originalEvent||b||k.event;var h=d(this).find(".eagle-item");l<e.options.maxZoom?(l=oldScale*c(q,a(b)),l>e.options.maxZoom&&
(l=e.options.maxZoom),e.newPos(h,l),e.updateImg(h,l,e.global.newX,e.global.newY),e.direction(h,l)):(oldScale=e.options.maxZoom,l=oldScale*c(q,a(b)),q=a(b))}function g(a){var b=d(this).find(".eagle-item");e.global.isZoom=!1;l>e.options.maxZoom&&(l=e.options.maxZoom);if(1>l||.01>Math.abs(l-1))l=1,b.css(n.addCssSpeed(300)),e.updateImg(b,l,e.global.newX,e.global.newY),setTimeout(function(){b.css(n.removeTransition());e.direction(b,l)},300),e.$gall.find(".top-controls.ea-hide").length||e.showTitle(b.find(".title"));
b.data("scale",l).attr("data-scale",l);e.direction(b,l);h("off")}var e=this,q=null,l,r;e.ev_types={startZoom:"touchstart",moveZoom:"touchmove",endZoom:"touchend touchcancel"};e.$gall.on("click",".eagle-scale .ea-plus",function(){var a=e.$gall.find(".owl-item.active .eagle-item");l=a.data("scale");0!=l%1&&(l=parseInt(l,10));l<e.options.maxZoom&&(1==l&&e.hideTitle(a.find(".title")),clearTimeout(k.remTran),a.css(n.addCssSpeed(200)),l++,e.updateImg(a,l,e.global.newX,e.global.newY),k.remTran=setTimeout(function(){a.css(n.removeTransition());
e.direction(a,l)},200),a.data("scale",l).attr("data-scale",l))});e.$gall.on("click",".eagle-scale .ea-minus",function(){var a=e.$gall.find(".owl-item.active .eagle-item");l=a.data("scale");0!=l%1?l=parseInt(l,10):1<l&&l--;1==l&&e.showTitle(a.find(".title"));e.newPos(a,l);clearTimeout(k.remTran);a.css(n.addCssSpeed(200));e.updateImg(a,l,e.global.newX,e.global.newY);k.remTran=setTimeout(function(){a.css(n.removeTransition());e.direction(a,l)},200);a.data("scale",l).attr("data-scale",l)});e.$gall.on(e.ev_types.startZoom,
".owl-item",function(c){c=c.originalEvent||c||k.event;var g=d(this).find(".eagle-item");if(0!=e.global.isDrag)return!1;2===c.touches.length&&(c.preventDefault(),e.global.isZoom=!0,q=a(c),b(q[0],a(c)[1]),oldScale=l=r=g.data("scale"),g.find(".title.hideTitle").length||g.find(".title.hideTitleMobile").length||e.hideTitle(g.find(".title")),h("on"))})},updateImg:function(a,b,c,h){b="scale3d("+b+", "+b+", 1)";c="translate3d("+c+"px, "+h+"px, 0px)";a.css({"-webkit-transform":b+c,"-o-transform":b+c,"-ms-transform":b+
c,"-moz-transform":b+c,transform:b+c})},direction:function(a,b){var c=a.find("img");c.offset().left+3>=a.closest(".owl-item").offset().left?this.global.leftDirection=!0:this.global.leftDirection=!1;c.offset().left+c.width()*b-3<=a.closest(".owl-item").offset().left+a.closest(".owl-item").width()?this.global.rightDirection=!0:this.global.rightDirection=!1;c.height()*b-2>a.closest(".owl-item").height()?this.global.topBottomDirection=!0:this.global.topBottomDirection=!1},newPos:function(a,b){var c=a.find("img");
if(c.width()*b>a.closest(".owl-item").width()){var h=(c.width()*b-a.closest(".owl-item").width())/2,d=this.global.newX*b;d>h&&(this.global.newX=(c.width()*b-a.closest(".owl-item").width())/(2*b));-d>h&&(this.global.newX=(a.closest(".owl-item").width()-c.width()*b)/(2*b))}else this.global.newX=0;c.height()*b>a.closest(".owl-item").height()?(h=(c.height()*b-a.closest(".owl-item").height())/2,d=this.global.newY*b,d>h&&(this.global.newY=(c.height()*b-a.closest(".owl-item").height())/(2*b)),-d>h&&(this.global.newY=
(a.closest(".owl-item").height()-c.height()*b)/(2*b))):this.global.newY=0},response:function(){var a=this,b,c,h;c=d(k).width();h=d(k).height();a.resizer=function(){if(!a.$gall)return!1;if(d(k).width()!==c||d(k).height()!==h)k.clearTimeout(b),b=k.setTimeout(function(){c=d(k).width();h=d(k).height();var b=a.$gall.find(".owl-item.active .eagle-item"),g=b.data("scale");a.newPos(b,g);a.updateImg(b,g,a.global.newX,a.global.newY);a.direction(b,g);b=a.$gall.find(".owl-item");a.isMobile()?b.each(function(){var a=
d(this).find(".title");a.hasClass("hideTitle")&&(a.addClass("hideTitleMobile"),a.removeClass("hideTitle"))}):b.each(function(){var a=d(this).find(".title");a.hasClass("hideTitleMobile")&&(a.addClass("hideTitle"),a.removeClass("hideTitleMobile"))});!a.isMobile()&&a.$gall.find(".top-controls").hasClass("ea-hide")&&(a.$gall.find(".top-controls, .bottom-controls").toggleClass("ea-hide"),b.each(function(){1==d(this).find(".eagle-item").data("scale")&&a.showTitle(d(this).find(".title"))}))},200)};d(k).resize(a.resizer)},
hideTitle:function(a){var b=this;if(!a.length)return!1;a.css(n.addCssSpeed(b.options.hideControlsSpeed));b.isMobile()?a.addClass("hideTitleMobile"):a.addClass("hideTitle");setTimeout(function(){a.css(n.removeTransition(b.options.hideControlsSpeed))},200)},showTitle:function(a){var b=this;if(!a.length)return!1;a.css(n.addCssSpeed(b.options.hideControlsSpeed));b.isMobile()?a.removeClass("hideTitleMobile"):a.removeClass("hideTitle");setTimeout(function(){a.css(n.removeTransition(b.options.hideControlsSpeed))},
200)},hideControls:function(){var a=this;if(a.isMobile()&&0==a.global.isNoDrag){a.$gall.find(".top-controls, .bottom-controls").toggleClass("ea-hide");var b=a.$gall.find(".owl-item");a.$gall.find(".top-controls").hasClass("ea-hide")?b.each(function(){1==d(this).find(".eagle-item").data("scale")&&a.hideTitle(d(this).find(".title"))}):b.each(function(){1==d(this).find(".eagle-item").data("scale")&&a.showTitle(d(this).find(".title"))})}},close:function(){var a=this;a.$gall.css({opacity:0});a.global.isZoom=
!1;a.global.leftDirection=!0;a.global.rightDirection=!0;a.global.topBottomDirection=!1;a.global.open=null;setTimeout(function(){a.owlGallery.destroy();a.$gall.remove();a.$gall=void 0;void 0!=a.bodyRightPadding?d("body").css({"padding-right":a.bodyRightPadding,overflow:"auto"}):d("body").css({"padding-right":0,overflow:"auto"});!1!==a.options.autoPlayMediumImg&&a.playMedium()},a.options.openGallerySpeed)},isMobile:function(){return this.$elem.find(".is-mobile").is(":visible")?!0:!1}};d.fn.eagleGallery=
function(a){return this.each(function(){Object.create(f).init(a,this)})};d.fn.eagleGallery.options={maxZoom:4,miniSliderArrowPos:"outside",miniSliderArrowStyle:1,showMediumImg:!0,changeMediumStyle:!1,changeMediumSpeed:600,autoPlayMediumImg:!1,openGalleryStyle:"show",openGallerySpeed:300,hideControlsSpeed:200,theme:"dark",bottomControlLine:!1,miniSlider:{navigation:!0,pagination:!1,navigationText:!1,rewindNav:!1,theme:"mini-slider",responsiveBaseWidth:".eagle-gallery",itemsCustom:[[0,1],[250,2],[450,
3],[650,4],[850,5],[1050,6],[1250,7],[1450,8]],margin:10},gallerySlider:{singleItem:!0,navigation:!1,pagination:!1,rewindNav:!1,addClassActive:!0,theme:"gallery-slider",galleryslider:!0}};var n={init:function(a,b){this.$elem=d(b);this.options=d.extend({},d.fn.owlCarouselE.options,this.$elem.data(),a);this.userOptions=a;this.loadContent()},loadContent:function(){function a(a){var c,d="";if("function"===typeof b.options.jsonSuccess)b.options.jsonSuccess.apply(this,[a]);else{for(c in a.owl)a.owl.hasOwnProperty(c)&&
(d+=a.owl[c].item);b.$elem.html(d)}b.logIn()}var b=this,c;"function"===typeof b.options.beforeInit&&b.options.beforeInit.apply(this,[b.$elem]);"string"===typeof b.options.jsonPath?(c=b.options.jsonPath,d.getJSON(c,a)):b.logIn()},logIn:function(){this.$elem.data("owl-originalStyles",this.$elem.attr("style"));this.$elem.data("owl-originalClasses",this.$elem.attr("class"));this.$elem.css({opacity:0});this.orignalItems=this.options.items;this.checkBrowser();this.wrapperWidth=0;this.checkVisible=null;
...
this.updateControls();this.eachMoveUpdate();"function"===typeof this.options.afterUpdate&&this.options.afterUpdate.apply(this,[this.$elem])},reload:function(){var a=this;k.setTimeout(function(){a.updateVars()},0)},watchVisibility:function(){var a=this;if(!1===a.$elem.is(":visible"))a.$elem.css({opacity:0}),k.clearInterval(a.autoPlayInterval),k.clearInterval(a.checkVisible);else return!1;a.checkVisible=k.setInterval(function(){a.$elem.is(":visible")&&(a.reload(),a.$elem.animate({opacity:1},200),k.clearInterval(a.checkVisible))},
500)},wrapItems:function(){this.$userItems.wrapAll('<div class="owl-wrapper">').wrap('<div class="owl-item"></div>');this.$elem.find(".owl-wrapper").wrap('<div class="owl-wrapper-outer">');this.wrapperOuter=this.$elem.find(".owl-wrapper-outer");this.$elem.css("display","block")},baseClass:function(){var a=this.$elem.hasClass(this.options.baseClass),b=this.$elem.hasClass(this.options.theme);a||this.$elem.addClass(this.options.baseClass);b||this.$elem.addClass(this.options.theme)},updateItems:function(){var a,
b;if(!1===this.options.responsive)return!1;if(!0===this.options.singleItem)return this.options.items=this.orignalItems=1,this.options.itemsCustom=!1,this.options.itemsDesktop=!1,this.options.itemsDesktopSmall=!1,this.options.itemsTablet=!1,this.options.itemsTabletSmall=!1,this.options.itemsMobile=!1;a=this.$elem.closest(d(this.options.responsiveBaseWidth)).width();a>(this.options.itemsDesktop[0]||this.orignalItems)&&(this.options.items=this.orignalItems);if(!1!==this.options.itemsCustom)for(this.options.itemsCustom.sort(function(a,
b){return a[0]-b[0]}),b=0;b<this.options.itemsCustom.length;b+=1)this.options.itemsCustom[b][0]<=a&&(this.options.items=this.options.itemsCustom[b][1]);else a<=this.options.itemsDesktop[0]&&!1!==this.options.itemsDesktop&&(this.options.items=this.options.itemsDesktop[1]),a<=this.options.itemsDesktopSmall[0]&&!1!==this.options.itemsDesktopSmall&&(this.options.items=this.options.itemsDesktopSmall[1]),a<=this.options.itemsTablet[0]&&!1!==this.options.itemsTablet&&(this.options.items=this.options.itemsTablet[1]),
a<=this.options.itemsTabletSmall[0]&&!1!==this.options.itemsTabletSmall&&(this.options.items=this.options.itemsTabletSmall[1]),a<=this.options.itemsMobile[0]&&!1!==this.options.itemsMobile&&(this.options.items=this.options.itemsMobile[1]);this.options.items>this.itemsAmount&&!0===this.options.itemsScaleUp&&(this.options.items=this.itemsAmount)},response:function(){var a=this,b,c;if(!0!==a.options.responsive)return!1;c=d(k).width();a.resizer=function(){d(k).width()!==c&&(!1!==a.options.autoPlay&&k.clearInterval(a.autoPlayInterval),
k.clearTimeout(b),b=k.setTimeout(function(){c=d(k).width();a.updateVars()},a.options.responsiveRefreshRate))};d(k).resize(a.resizer)},updatePosition:function(){this.jumpTo(this.currentItem);!1!==this.options.autoPlay&&this.checkAp()},appendItemsSizes:function(){var a=this,b=0,c=a.itemsAmount-a.options.items;a.$owlItems.each(function(h){var f=d(this);f.css({width:a.itemWidth,"margin-right":a.options.margin}).data("owl-item",Number(h));if(0===h%a.options.items||h===c)h>c||(b+=1);f.data("owl-roundPages",
b)})},appendWrapperSizes:function(){this.$owlWrapper.css({width:this.$owlItems.length*this.itemWidth*2,left:0});this.appendItemsSizes()},calculateAll:function(){this.calculateWidth();this.appendWrapperSizes();this.loops();this.max()},calculateWidth:function(){this.itemWidth=Math.round((this.$elem.width()-(this.options.items-1)*this.options.margin)/this.options.items)},max:function(){var a=-1*(this.itemsAmount*this.itemWidth+this.options.margin*(this.itemsAmount-1)-this.options.items*this.itemWidth-
(this.options.items-1)*this.options.margin);this.options.items>this.itemsAmount?this.maximumPixels=a=this.maximumItem=0:(this.maximumItem=this.itemsAmount-this.options.items,this.maximumPixels=a);return a},min:function(){return 0},loops:function(){var a=0,b=0,c,h;this.positionsInArray=[0];this.pagesInArray=[];for(c=0;c<this.itemsAmount;c+=1)b=c+1==this.itemsAmount?b+this.itemWidth:b+(this.itemWidth+this.options.margin),this.positionsInArray.push(-b),!0===this.options.scrollPerPage&&(h=d(this.$owlItems[c]),
h=h.data("owl-roundPages"),h!==a&&(this.pagesInArray[a]=this.positionsInArray[c],a=h))},buildControls:function(){if(!0===this.options.navigation||!0===this.options.pagination)this.owlControls=d('<div class="owl-controls"/>').toggleClass("clickable",!this.browser.isTouch).appendTo(this.$elem);!0===this.options.pagination&&this.buildPagination();!0===this.options.navigation&&this.buildButtons()},buildButtons:function(){var a=this,b=d('<div class="owl-buttons"/>');a.owlControls.append(b);a.buttonPrev=
...
d('<div class="owl-pagination"/>');a.owlControls.append(a.paginationWrapper);a.paginationWrapper.on("touchend.owlControls mouseup.owlControls",".owl-page",function(b){b.preventDefault();Number(d(this).data("owl-page"))!==a.currentItem&&a.goTo(Number(d(this).data("owl-page")),!0)})},updatePagination:function(){var a,b,c,h,f,g;if(!1===this.options.pagination)return!1;this.paginationWrapper.html("");a=0;b=this.itemsAmount-this.itemsAmount%this.options.items;for(h=0;h<this.itemsAmount;h+=1)0===h%this.options.items&&
(a+=1,b===h&&(c=this.itemsAmount-this.options.items),f=d("<div/>",{"class":"owl-page"}),g=d("<span></span>",{text:!0===this.options.paginationNumbers?a:"","class":!0===this.options.paginationNumbers?"owl-numbers":""}),f.append(g),f.data("owl-page",b===h?c:h),f.data("owl-roundPages",a),this.paginationWrapper.append(f));this.checkPagination()},checkPagination:function(){var a=this;if(!1===a.options.pagination)return!1;a.paginationWrapper.find(".owl-page").each(function(){d(this).data("owl-roundPages")===
...
this.owl.currentItem=a;this.afterGo()},afterGo:function(){var a=this;a.prevArr.push(a.currentItem);a.prevItem=a.owl.prevItem=a.prevArr[a.prevArr.length-2];a.prevArr.shift(0);if(a.prevItem!==a.currentItem&&(a.checkPagination(),a.checkNavigation(),a.eachMoveUpdate(),!1!==a.options.autoPlay&&a.checkAp(),a.options.galleryslider)){var b=a.$elem.find(".owl-item.active").index()+1;a.$elem.closest(".eagle-open-gallery").find(".ea-current").html(b);1==b?(a.$elem.closest(".eagle-open-gallery").find(".eagle-prev").addClass("disabled"),
a.$elem.closest(".eagle-open-gallery").find(".eagle-next").removeClass("disabled")):b==a.$elem.find(".owl-item").length?(a.$elem.closest(".eagle-open-gallery").find(".eagle-next").addClass("disabled"),a.$elem.closest(".eagle-open-gallery").find(".eagle-prev").removeClass("disabled")):a.$elem.closest(".eagle-open-gallery").find(".eagle-next, .eagle-prev").removeClass("disabled");setTimeout(function(){a.$owlItems.find(".eagle-item").removeAttr("style");f.global.open.find(".top-controls").hasClass("ea-hide")||
a.$owlItems.find(".title").removeClass("hideTitle").removeClass("hideTitleMobile");f.global.leftDirection=!0;f.global.rightDirection=!0;f.global.topBottomDirection=!1;f.global.newX=0;f.global.newY=0;a.$owlItems.find(".eagle-item").data("scale",1)},a.options.slideSpeed)}"function"===typeof a.options.afterMove&&a.prevItem!==a.currentItem&&a.options.afterMove.apply(this,[a.$elem])},stop:function(){this.apStatus="stop";k.clearInterval(this.autoPlayInterval)},checkAp:function(){"stop"!==this.apStatus&&
this.play()},play:function(){var a=this;a.apStatus="play";if(!1===a.options.autoPlay)return!1;k.clearInterval(a.autoPlayInterval);a.autoPlayInterval=k.setInterval(function(){a.next(!0)},a.options.autoPlay)},swapSpeed:function(a){"slideSpeed"===a?this.$owlWrapper.css(this.addCssSpeed(this.options.slideSpeed)):"paginationSpeed"===a?this.$owlWrapper.css(this.addCssSpeed(this.options.paginationSpeed)):"string"!==typeof a&&this.$owlWrapper.css(this.addCssSpeed(a))},addCssSpeed:function(a){return{"-webkit-transition":"all "+
a+"ms ease","-moz-transition":"all "+a+"ms ease","-o-transition":"all "+a+"ms ease",transition:"all "+a+"ms ease"}},removeTransition:function(){return{"-webkit-transition":"","-moz-transition":"","-o-transition":"",transition:""}},doTranslate:function(a){return{"-webkit-transform":"translate3d("+a+"px, 0px, 0px)","-moz-transform":"translate3d("+a+"px, 0px, 0px)","-o-transform":"translate3d("+a+"px, 0px, 0px)","-ms-transform":"translate3d("+a+"px, 0px, 0px)",transform:"translate3d("+a+"px, 0px,0px)"}},
transition3d:function(a){this.$owlWrapper.css(this.doTranslate(a))},css2move:function(a){this.$owlWrapper.css({left:a})},css2slide:function(a,b){var d=this;d.isCssFinish=!1;d.$owlWrapper.stop(!0,!0).animate({left:a},{duration:b||d.options.slideSpeed,complete:function(){d.isCssFinish=!0}})},checkBrowser:function(){var a=p.createElement("div");a.style.cssText="  -moz-transform:translate3d(0px, 0px, 0px); -ms-transform:translate3d(0px, 0px, 0px); -o-transform:translate3d(0px, 0px, 0px); -webkit-transform:translate3d(0px, 0px, 0px); transform:translate3d(0px, 0px, 0px)";
